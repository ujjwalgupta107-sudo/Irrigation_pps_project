...
It uses C programming concepts such as structures, pointers, arrays, dynamic memory, and modular programming.THis is a beginner level C- project created in the first semester 
Project Features:
